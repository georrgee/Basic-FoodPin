...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        if let barFont = UIFont(name: "AvenirNextCondensed-DemiBold", size: 28.0){
        ...
        UIApplication.shared.statusBarStyle = .lightContent // no more black status bar
        ...
        // adding selection Indicator Image in the background (i.e. orange background when touched)
